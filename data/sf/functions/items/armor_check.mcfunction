#防具の防御力処理
    #付けた時の
        #103
            ...
            execute as @s[scores={A.CheckA3_CB=2}] run function sf:items/armor_update
        ...
        #102
            ...
            execute as @s[scores={A.CheckA2_CB=2}] run function sf:items/armor_update
        ...
        #101
            ...
            execute as @s[scores={A.CheckA1_CB=2}] run function sf:items/armor_update
        ...
        #100
            ...
            execute as @s[scores={A.CheckA0_CB=2}] run function sf:items/armor_update
    ...
    #外した時の
        #103
            ...
            execute as @s[scores={A.CheckB3_CB=2}] run function sf:items/armor_update
        ...
        #102
            ...
            execute as @s[scores={A.CheckB2_CB=2}] run function sf:items/armor_update
        ...
        #101
            ...
            execute as @s[scores={A.CheckB1_CB=2}] run function sf:items/armor_update
        ...
        #100
            ...
            execute as @s[scores={A.CheckB0_CB=2}] run function sf:items/armor_update
