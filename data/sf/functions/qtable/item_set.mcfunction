...
execute align xz positioned ~0.5 ~ ~0.5 as @e[tag=QT_Target,distance=..0.625,limit=9] at @s run function sf:qtable/rotation/rotation_lock
execute if entity @s[y_rotation=-45..45] align xz positioned ~0.5 ~-1 ~0.5 as @e[tag=QT_Core,tag=!QT_RotLock,distance=..0.001,limit=1] unless entity @s[y_rotation=0] at @s positioned ~ ~1 ~ run function sf:qtable/rotation/y0
execute if entity @s[y_rotation=45..135] align xz positioned ~0.5 ~-1 ~0.5 as @e[tag=QT_Core,tag=!QT_RotLock,distance=..0.001,limit=1] unless entity @s[y_rotation=90] at @s positioned ~ ~1 ~ run function sf:qtable/rotation/y90
execute if entity @s[y_rotation=135..225] align xz positioned ~0.5 ~-1 ~0.5 as @e[tag=QT_Core,tag=!QT_RotLock,distance=..0.001,limit=1] unless entity @s[y_rotation=180] at @s positioned ~ ~1 ~ run function sf:qtable/rotation/y180
execute if entity @s[y_rotation=-135..-45] align xz positioned ~0.5 ~-1 ~0.5 as @e[tag=QT_Core,tag=!QT_RotLock,distance=..0.001,limit=1] unless entity @s[y_rotation=-90] at @s positioned ~ ~1 ~ run function sf:qtable/rotation/y-90
...
execute as @e[tag=QT_TmpItem,distance=..0.001,limit=1] run function #sf:qtable/positions
...
execute as @e[tag=QT_Slot,distance=..0.001,limit=1] at @s run function sf:qtable/item_place
...
execute align xz positioned ~0.5 ~-1 ~0.5 as @e[tag=QT_Core,distance=..0.001,limit=1] positioned ~ ~1 ~ run function #sf:qtable/recipes
