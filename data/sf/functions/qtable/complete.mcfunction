...
execute as @e[tag=QT_Target,distance=..0.625,limit=9] at @s run function #sf:qtable/positions
tag @e[tag=QT_Complete,distance=..0.625,limit=9] remove QT_complete

#リサイクル
execute as @e[tag=QT_Target,distance=..0.625,limit=9] at @s positioned ~ ~-1 ~ run function #sf:qtable/recycle_items
...
execute as @e[tag=QT_Slot,distance=..0.625,limit=9] at @s run function sf:qtable/item_place
tag @s remove QT_RotLock
execute as @e[tag=QT_Target,distance=..0.625,limit=9] at @s run function sf:qtable/rotation/rotation_lock
