execute align xz run summon minecraft:item ~0.5 ~0.3 ~0.5 {Item:{id:green_banner,Count:2b},Tags:[QT_Crafted],NoGravity:true,PickupDelay:32767s,Health:32767s,Age:-32768s}
