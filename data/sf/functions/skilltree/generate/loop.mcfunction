...
#実際に配置するステータス増加量の計算
    ...
    execute if score $Global GlobalVer_CB matches 01 run data modify storage chenbr:sf data.skillTree.1 append value 1B
    ...
    execute if score $Global GlobalVer_CB matches 02 run data modify storage chenbr:sf data.skillTree.1 append value 2B
    ...
    execute if score $Global GlobalVer_CB matches 03 run data modify storage chenbr:sf data.skillTree.1 append value 3B
    ...
    execute if score $Global GlobalVer_CB matches 04 run data modify storage chenbr:sf data.skillTree.1 append value 4B
    ...
    execute if score $Global GlobalVer_CB matches 05 run data modify storage chenbr:sf data.skillTree.2 append value 1B
    ...
    execute if score $Global GlobalVer_CB matches 06 run data modify storage chenbr:sf data.skillTree.2 append value 2B
    ...
    execute if score $Global GlobalVer_CB matches 07 run data modify storage chenbr:sf data.skillTree.2 append value 3B
    ...
    execute if score $Global GlobalVer_CB matches 08 run data modify storage chenbr:sf data.skillTree.2 append value 4B
    ...
    execute if score $Global GlobalVer_CB matches 09 run data modify storage chenbr:sf data.skillTree.3 append value 1B
    ...
    execute if score $Global GlobalVer_CB matches 10 run data modify storage chenbr:sf data.skillTree.3 append value 2B
    ...
    execute if score $Global GlobalVer_CB matches 11 run data modify storage chenbr:sf data.skillTree.3 append value 3B
    ...
    execute if score $Global GlobalVer_CB matches 12 run data modify storage chenbr:sf data.skillTree.3 append value 4B
    ...
    execute if score $Global GlobalVer_CB matches 13 run data modify storage chenbr:sf data.skillTree.4 append value 1B
    ...
    execute if score $Global GlobalVer_CB matches 14 run data modify storage chenbr:sf data.skillTree.4 append value 2B
    ...
    execute if score $Global GlobalVer_CB matches 15 run data modify storage chenbr:sf data.skillTree.4 append value 3B
    ...
    execute if score $Global GlobalVer_CB matches 16 run data modify storage chenbr:sf data.skillTree.4 append value 4B
    ...
    execute if score $ST:GenerateCount Random_CB matches 01..06 run data modify storage chenbr:sf data.skillTree.1 append value -1B
    execute if score $ST:GenerateCount Random_CB matches 07..18 run data modify storage chenbr:sf data.skillTree.2 append value -1B
    execute if score $ST:GenerateCount Random_CB matches 19..36 run data modify storage chenbr:sf data.skillTree.3 append value -1B
    execute if score $ST:GenerateCount Random_CB matches 37..60 run data modify storage chenbr:sf data.skillTree.4 append value -1B
    execute if score $ST:GenerateCount Random_CB matches 01..06 store result storage chenbr:sf data.skillTree.1[-1] byte 1 run scoreboard players get $ST:RandOut Random_CB
    execute if score $ST:GenerateCount Random_CB matches 07..18 store result storage chenbr:sf data.skillTree.2[-1] byte 1 run scoreboard players get $ST:RandOut Random_CB
    execute if score $ST:GenerateCount Random_CB matches 19..36 store result storage chenbr:sf data.skillTree.3[-1] byte 1 run scoreboard players get $ST:RandOut Random_CB
    execute if score $ST:GenerateCount Random_CB matches 37..60 store result storage chenbr:sf data.skillTree.4[-1] byte 1 run scoreboard players get $ST:RandOut Random_CB
