# ピストン対策
execute as @e[tag=QT_Core] at @s run function qrafting_table:piston/piston
# スロット選択
...
execute as @e[tag=QT_Core] at @s unless block ~ ~ ~ crafting_table unless block ~ ~ ~ moving_piston run function qrafting_table:delete
