...
#置換処理
    ...
    execute if score $ASS_ListNest ASS_ChenBR matches 1 run data modify storage chenbr:ass_data Array[0][0][0] set from storage chenbr:ass_data Input[0].ReplaceValue
    ...
    execute if score $ASS_ListNest ASS_ChenBR matches 1 run data modify storage chenbr:ass_data Array[0][0] set from storage chenbr:ass_data Input[0].ReplaceValue
    execute if score $ASS_ListNest ASS_ChenBR matches 1 run scoreboard players set $ASS_ListNest ASS_ChenBR -1
    ...
    execute if score $ASS_ListNest ASS_ChenBR matches 1 run data modify storage chenbr:ass_data Array[0] set from storage chenbr:ass_data Input[0].ReplaceValue
